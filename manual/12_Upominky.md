...
2. **Hromadně** z [Seznamu faktur](08_Faktury.md) (bulk action)
...
## 12.2 Manuální upomínka

Otevři [Detail faktury](10_Faktura_PDF.md) → tlačítko **Upomínka**.
...
1. Pro každou fakturu zkontroluje, že splňuje předpoklady (§ 12.1)
...
## 12.4 Cron — automatické upomínky
